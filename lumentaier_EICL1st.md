...
### 2024.6.25
第一天看A programmer's guide to English
自己目前单词用墨墨，文章用扇贝阅读。单词还好，阅读一直属于普通的单个单词原型都认识，放在语句里就难以理解，并且在不同时态等复杂语法的情况下阅读能力等于无。最近在看一些语法视频，通过识别语句中的连系动词等关键词把语句简化，收效甚微，需要持续训练。
